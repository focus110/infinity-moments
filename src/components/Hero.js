...
const Hero = () => {
  return (
    <div className="wrapper relative">
      ...
      <div className="absolute top-[55%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[85%] md:w-[75%] flex justify-between items-start">
        <div>
          <img
        ...
        <div>
          <img
            ...
            alt="!#"
          />
          <p className="text-white text-sm md:text-lg font-black">Sandra J.</p>
        </div>
      </div>
